  ...
  return e("div",{style:{background:C.bg,minHeight:"100vh",fontFamily:"'DM Sans',sans-serif",color:C.tx}},
    ...
    e("div",{style:{background:"linear-gradient(180deg,rgba(13,18,36,.98),rgba(6,10,20,.95))",borderBottom:"1px solid "+C.bd,padding:"12px 16px",position:"sticky",top:0,zIndex:100,backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)"}},
      e("div",{style:{maxWidth:"900px",margin:"0 auto",display:"flex",alignItems:"center",gap:"10px"}},
        ...
        vista!=="home"&&e("div",{style:{display:"flex",alignItems:"center",gap:"4px",fontSize:"11px",flexShrink:0}},
          ...
          vista==="anat"&&e(F,null,e("span",{style:{color:"rgba(255,255,255,.15)"}}," › "),e("span",{style:{color:C.mt}},"Anatomía")),
          vista==="cir_ing"&&e(F,null,e("span",{style:{color:"rgba(255,255,255,.15)"}}," › "),e("span",{onClick:function(){go("anat")},style:{color:C.dm,cursor:"pointer"}},"Anatomía"),e("span",{style:{color:"rgba(255,255,255,.15)"}}," › "),e("span",{style:{color:C.mt}},"Conducto Inguinal")),
    ...
    sb&&e("div",{style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",zIndex:150,display:"flex"}},
      e("div",{style:{background:C.cd,width:"290px",height:"100%",borderRight:"1px solid "+C.bd,overflow:"auto",padding:"20px",boxShadow:"4px 0 30px rgba(0,0,0,.5)"}},
        ...
        [{ic:"🦴",n:"Reumatología",v:"reuma",col:"#60a5fa",act:true,sub:REUMA_SECS.map(function(s){return{n:s.i+" "+s.n,v:"reuma_sec",sec:s.id}})},
         ...
         {ic:"🩻",n:"Anatomía",v:"anat",col:"#f59e0b",act:true,sub:[{n:"🧠 Pares Craneales",v:"anat"},{n:"🧱 Conducto Inguinal",v:"cir_ing"}]},
    ...
    vista==="home"&&e(F,null,
      ...
      e("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:"14px"}},
        MODS.filter(function(m){return["triadas","labs","imagenes","general"].indexOf(m.id)===-1}).map(function(m,i){
          var lleno=m.st==="lleno";
          return e("div",{key:m.id,onClick:function(){if(lleno)go(m.id==="cirugia"?"cir_menu":m.id==="anatomia"?"anat":m.id==="labs"?"labs":m.id==="epid"?"epid":m.id==="emergen"?"emergen_menu":m.id==="fisio"?"fisio":m.id)},style:{
    ...
    // ════════════ ANATOMÍA (HUB) ════════════
    vista==="anat"&&e(F,null,
      e("div",{style:{textAlign:"center",marginBottom:"28px"}},e("div",{style:{fontSize:"40px",marginBottom:"8px"}},"🩻"),e("h2",{style:{fontFamily:"'Playfair Display',serif",fontSize:"22px",fontWeight:800,color:"#f59e0b"}},"Anatomía"),e("p",{style:{color:C.dm,fontSize:"13px"}},"Pares Craneales, Conducto Inguinal y más")),
      // PARES CRANEALES
      e("div",{style:{marginBottom:"24px"}},
        e("div",{onClick:function(){setAbdOpen(abdOpen==="craneales"?null:"craneales")},style:{background:C.cd,border:"1px solid "+(abdOpen==="craneales"?"#a78bfa44":C.bd),borderRadius:"14px",padding:"18px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between"}},
          e("div",{style:{display:"flex",alignItems:"center",gap:"12px"}},e("span",{style:{fontSize:"24px"}},"🧠"),e("div",null,e("h3",{style:{fontSize:"16px",fontWeight:700,color:"#a78bfa"}},"Pares Craneales"),e("p",{style:{fontSize:"11px",color:C.dm}},"12 pares con origen real, origen aparente, función y clínica"))),
        ...
        abdOpen==="craneales"&&e("div",{style:{marginTop:"10px"}},
          NERVES.map(function(n,i){
            var nc_col=["#c084fc","#60a5fa","#34d399","#fbbf24","#fb923c","#f472b6","#e879f9","#38bdf8","#4ade80","#86efac","#fde68a","#fca5a5"];
            var col=nc_col[i]||"#94a3b8";
            var isExp2=abdExp["nc_"+n.id];
            var tc2={"Sensitivo":"#60a5fa","Motor":"#34d399","Mixto":"#e879f9"};
            var tipoCol=tc2[n.tipo]||"#94a3b8";
            return e("div",{key:n.id,style:{background:C.cd,border:"1px solid "+(isExp2?col+"44":C.bd),borderRadius:"12px",marginBottom:"8px",overflow:"hidden",animation:"fadeIn .3s ease"}},
              e("div",{onClick:function(){var nw={};for(var k in abdExp)nw[k]=abdExp[k];nw["nc_"+n.id]=!isExp2;setAbdExp(nw)},style:{padding:"14px 16px",cursor:"pointer",display:"flex",alignItems:"center",gap:"12px"}},
                e("span",{style:{fontFamily:"'Playfair Display',serif",fontSize:"20px",fontWeight:900,color:col,minWidth:"36px"}},n.num),
                e("div",{style:{flex:1}},
                  e("div",{style:{fontWeight:700,fontSize:"14px",color:C.tx}},n.n)
                ),
                e("span",{style:{fontSize:"9px",padding:"2px 8px",borderRadius:"100px",background:tipoCol+"15",color:tipoCol,border:"1px solid "+tipoCol+"30"}},n.tipo),
              ...
              isExp2&&e("div",{style:{padding:"0 16px 16px",borderTop:"1px solid "+C.bd}},
                e("div",{style:{padding:"12px 14px",background:col+"08",borderRadius:"8px",borderLeft:"3px solid "+col,margin:"12px 0",fontSize:"13px",color:C.tx,lineHeight:1.7}},n.desc),
                n.ramas&&n.ramas.length>0&&e("div",{style:{marginTop:"10px"}},
                  e("div",{style:{fontSize:"10px",fontWeight:700,color:col,marginBottom:"6px",textTransform:"uppercase",letterSpacing:".05em"}},"RAMAS"),
                  n.ramas.map(function(r,ri){
                    return e("div",{key:ri,style:{padding:"8px 12px",background:"rgba(255,255,255,.03)",borderRadius:"8px",borderLeft:"2px solid "+col+"60",marginBottom:"4px",fontSize:"12px",color:C.mt,lineHeight:1.6}},r)
                  })
                ),
                e("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"8px",marginTop:"10px"}},
                  e("div",{style:{padding:"10px",background:"rgba(255,255,255,.03)",borderRadius:"8px"}},e("div",{style:{fontSize:"10px",fontWeight:700,color:C.dm,marginBottom:"3px"}},"ORIGEN REAL"),e("div",{style:{fontSize:"11px",color:C.mt,lineHeight:1.5}},n.origen_real)),
      ...
      // CONDUCTO INGUINAL (link card)
      e("div",{onClick:function(){go("cir_ing")},style:{background:C.cd,border:"1px solid "+C.bd,borderRadius:"14px",padding:"18px",cursor:"pointer",marginBottom:"12px",display:"flex",alignItems:"center",gap:"14px"}},
        e("span",{style:{fontSize:"28px"}},"🧱"),e("div",null,e("h3",{style:{fontSize:"15px",fontWeight:700}},"Conducto Inguinal"),e("p",{style:{fontSize:"12px",color:C.dm}},"Paredes, Anillos superficial y profundo, Cordón espermático")),e("span",{style:{color:C.dm,marginLeft:"auto"}},"›"))
    ),
