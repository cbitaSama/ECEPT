...
function ImpView(p){
  ...
  var general=[
    ...
    {id:"perlas",ic:"📌",t:"Perlas de examen",sub:"Alto rendimiento",c:c,
     content:e("div",null,
       ...
       e(Pearl,{t:"Impulso vs compulsión"},"Ambos son actos repetitivos, pero: el ",e("b",null,"impulso")," (cleptomanía, piromanía, TEI) surge como ",e("b",null,"tensión previa + placer o alivio durante/después del acto"),"; NO responde a una obsesión. La ",e("b",null,"compulsión")," (capítulo TOC) responde a una ",e("b",null,"obsesión")," y busca neutralizar ansiedad — no hay placer inherente, sólo alivio.")
     )},
  ...
  return e("div",null,
    ...
    e("div",{style:{padding:"14px 16px",background:"linear-gradient(135deg,"+ax(c,.12)+","+ax(c,.03)+" 90%)",border:"1px solid "+ax(c,.3),borderRadius:14,margin:"22px 0 4px",textAlign:"center"}},
      ...
      e("div",{style:{fontSize:16,fontWeight:900,color:"#fff",letterSpacing:.1,lineHeight:1.2,fontFamily:"Inter,DM Sans"}},"Conceptos · DDx · Flashcards · Quiz")
    ),
