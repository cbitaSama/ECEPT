  ...
  var general=[
    ...
    {id:"perlas",ic:"📌",t:"Perlas de examen",sub:"Alto rendimiento",c:c,
     content:e("div",null,
       ...
       e(Pearl,{t:"TOC vs TOCP — ego-distónico vs ego-sintónico"},"El ",e("b",null,"TOC")," (este capítulo) es ",e("b",null,"EGO-DISTÓNICO"),": el paciente vive sus obsesiones como ",e("b",null,"intrusivas y ajenas"),", le generan ansiedad y busca librarse de ellas. El ",e("b",null,"TOCP")," (trastorno de la personalidad obsesivo-compulsiva · capítulo Personalidad) es ",e("b",null,"EGO-SINTÓNICO"),": el paciente considera su rigidez y perfeccionismo como rasgos propios y correctos, y NO busca cambiarlos. Son entidades distintas.")
     )},
