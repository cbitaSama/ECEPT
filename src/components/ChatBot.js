    ...
    CB_open && e("div",{
      ...
      e("div",{style:{padding:"10px 12px 10px 16px", borderBottom:"1px solid "+C.bd, display:"flex", alignItems:"center", justifyContent:"space-between", background:C.bg}},
        e("div",{style:{display:"flex",alignItems:"center",gap:"8px",overflow:"hidden"}},
          e("span",{style:{fontSize:"18px",flexShrink:0}},"🤖"),
          e("div",{style:{fontWeight:700, color:C.tx, fontSize:"14px",flexShrink:0}},"Asistente ECEPT"),
          CB_session===true&&(
            CB_role==="student"
              ? e("span",{style:{
                  ...
                  flexShrink:0
                }},CB_usageCount+" / "+CB_LIMITS.student+" mens.")
              : e("div",{style:{display:"flex",alignItems:"center",gap:"4px",flexShrink:0}},
                  e("span",{style:{
