    ...
    function convItem(conv, idx) {
      ...
      return e('div', { key:conv.id, style:{ marginBottom:4, position:'relative' } },
        ...
        isMenuOpen && e('div', {
          ...
          e('button', {
            onClick:function(ev) { ev.stopPropagation(); CB_archiveConv(conv.id); CB_setConvMenuId(null); },
            style:{ display:'block', width:'100%', padding:'9px 12px', background:'none', border:'none', color:'#ef4444', fontSize:13, cursor:'pointer', textAlign:'left', borderRadius:6, fontFamily:'inherit' }
          }, '🗑 Archivar')
        )
      );
    }
